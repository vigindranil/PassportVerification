...
const dashboardConfig = {
  ...
  20: [
    {
      title: "Total Pending Applications to Accept",
      key: "TotalPendingApplications",
      icon: CircleDashed,
      color: "purple",
      link: "/totalPending",
    ...
    {
      title: "Verification Pending (SP/DIB)",
      key: "SPPending",
    ...
    {
      title: "Last 15 Days Pending to Accept",
      key: "Last15DaysPendingApplications",
      icon: TrendingDown,
      color: "blue",
      link: "/last15DaysPending",
