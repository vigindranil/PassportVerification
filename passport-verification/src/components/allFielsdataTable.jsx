      ...
      <div className="mt-0 bg-white dark:bg-gray-800 rounded-t-lg overflow-hidden">
        <div className="bg-gradient-to-r from-yellow-600 to-yellow-400 px-6 py-3">
          <h2 className="text-2xl font-bold text-white">
            {status === 30
              ? `Special Applications at ${EO_POLICE_STATION || ""} PS`
              : `Total Pending Applications at ${EO_POLICE_STATION || ""} PS`}
          </h2>
        </div>
      </div>
      <div className="p-6">
              ...
              <div className="space-y-2">
                <ul>
                  <li className="text-sm">
                    <span className="font-bold text-md">PV Sequence:</span>{" "}
                    {selectedDetails.PVSequenceNo}
                  </li>
                  <li className="text-sm">
                    <span className="font-bold text-md">File Number:</span>{" "}
                    {selectedDetails.FileNumber}
                  </li>
                  <li className="text-sm">
                    <span className="font-bold text-md">Email ID:</span>{" "}
                    {selectedDetails.EmailID}
                  </li>
                  <li className="text-sm">
                    <span className="font-bold text-md">Applicant Name:</span>{" "}
                    {selectedDetails.ApplicantName}
                  </li>
                  <li className="text-sm">
                    <span className="font-bold text-md">Police Station:</span>{" "}
                    {selectedDetails.PsName}
                  </li>
                  <li className="text-sm">
                    <span className="font-bold text-md">Phone No:</span>{" "}
                    {selectedDetails.PhoneNo}
                  </li>
                  <li className="text-sm">
                    <span className="font-bold text-md">Spouse Name:</span>{" "}
                    {selectedDetails.SpouseName}
                  </li>
                  <li className="text-sm">
                    <span className="font-bold text-md">Address:</span>{" "}
                    {selectedDetails.VerificationAddress}
                  </li>
                  <li className="text-sm">
                  ...
                  <li className="text-sm">
                    <span className="font-bold text-md">Place Of Birth:</span>{" "}
                    {selectedDetails.PlaceOfBirth}
                  </li>
                </ul>
              </div>
            </DialogContent>
