...
export default function Proceed() {
  ...
  const fetchApplicationStatus = async () => {
    try {
      const response = await getApplicationStatus(5,15);
        ...
        <Dialog open={isDetailsModalOpen} onOpenChange={setIsDetailsModalOpen}>
          <DialogContent>
            ...
            <div className="space-y-2">
              <ul>
                <li className="text-sm"><span className="font-bold text-md">PV Sequence:</span> {selectedDetails.PVSequenceNo}</li>
                <li className="text-sm"><span className="font-bold text-md">File Number:</span> {selectedDetails.FileNumber}</li>
                <li className="text-sm"><span className="font-bold text-md">Email ID:</span> {selectedDetails.EmailID}</li>
                <li className="text-sm"><span className="font-bold text-md">Applicant Name:</span> {selectedDetails.ApplicantName}</li>
                <li className="text-sm"><span className="font-bold text-md">Police Station:</span> {selectedDetails.Ps_Name}</li>
                <li className="text-sm"><span className="font-bold text-md">Phone No:</span> {selectedDetails.PhoneNo}</li>
                <li className="text-sm"><span className="font-bold text-md">Spouse Name:</span> {selectedDetails.SpouseName}</li>
                <li className="text-sm"><span className="font-bold text-md">Address:</span> {selectedDetails.VerificationAddress}</li>
                <li className="text-sm"><span className="font-bold text-md">Gender:</span> {selectedDetails.Gender}</li>
                <li className="text-sm"><span className="font-bold text-md">Place Of Birth:</span> {selectedDetails.PlaceOfBirth}</li>
              </ul>
            </div>
          </DialogContent>
        </Dialog>
