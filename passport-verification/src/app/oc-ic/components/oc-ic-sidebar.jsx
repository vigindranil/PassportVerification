...
const OcIcSidebar = () => {
    ...
    return (
        <div className="flex flex-col h-screen w-64 bg-gradient-to-b from-purple-600 to-indigo-700 text-white">
            <div className="p-5">
                <h2 className="text-2xl font-bold">Oc/Ic USer</h2>
            </div>
            <nav className="flex-1">
                <ul className="space-y-2 px-3">
                    {[
                        ...
                        // { icon: CirclePlus, label: 'Create User', href: '/createUserForm' },
                        { icon: ShieldCheck, label: 'EO Files Verify', href: '/products' },
